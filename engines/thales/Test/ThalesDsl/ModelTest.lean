...
#guard decide (TsModel.answer = (pure 42 : TsM Int))

-- Negative literals.
ts_def "minus3" := ts.fn() : ts.number { ts.return(ts.num[-3]) }
#guard decide (TsModel.minus3 = (pure (-3) : TsM Int))
...
#guard decide (TsModel.twice 7 = (pure 14 : TsM Int))
...
#guard decide (TsModel.affine 10 = (pure 21 : TsM Int))
