-- A provable class-binder obligation under a budget whose generic share
-- completes but whose grind share does not: the grind rung's starvation
-- must report as the annotation's Timeout, not as a residual-goal GaveUp.
import ThalesDsl
...
set_option thales.heartbeats 8000
