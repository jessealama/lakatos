...
`Object` and `Function` directories #389 added, and the three template
and object-literal directories #395 added — and
...
#382, on #388, on #384, on #393, on #389, or on #395: no failure in the slice is
...
`Function` member answering the wrong thing**, and **none is an object
literal's members running out of order or defining the wrong thing, or a
template building the wrong string or the wrong template object**.
...
| `test/built-ins/Function/prototype/Symbol.hasInstance`                | 10    | builtin      | `Symbol` is not in the realm                                                                                                             | #392  |
...
| `test/built-ins/Object/assign`                                        | 12    | builtin      | `Symbol` is not in the realm                                                                                                             | #392  |
...
| `test/built-ins/Object/freeze`                                        | 3     | builtin      | `Symbol` is not in the realm                                                                                                             | #392  |
| `test/built-ins/Object/freeze`                                        | 1     | out-of-scope | `Date` is excluded by the epic                                                                                                           | #376  |
| `test/built-ins/Object/freeze`                                        | 2     | out-of-scope | `Proxy` and `Reflect` are excluded by the epic                                                                                           | #376  |
...
| `test/built-ins/Object/fromEntries`                                   | 13    | builtin      | `Symbol` is not in the realm                                                                                                             | #392  |
...
| `test/built-ins/Object/groupBy`                                       | 2     | builtin      | `Symbol` is not in the realm                                                                                                             | #392  |
| `test/built-ins/Object/hasOwn`                                        | 5     | builtin      | `Symbol` is not in the realm                                                                                                             | #392  |
...
| `test/built-ins/Object/prototype/hasOwnProperty`                      | 1     | bug          | `hasOwnProperty` converts a `null` or `undefined` receiver before its key, so the key's own `toString` never runs                        | #509  |
...
| `test/built-ins/Object/seal`                                          | 4     | builtin      | `Symbol` is not in the realm                                                                                                             | #392  |
| `test/built-ins/Object/seal`                                          | 3     | out-of-scope | `Proxy` and `Reflect` are excluded by the epic                                                                                           | #376  |
...
| `test/harness`                                                        | 8     | builtin      | `Symbol` is not in the realm                                                                                                             | #392  |
...
| `test/language/expressions/object`                                    | 7     | builtin      | `Symbol` is not in the realm                                                                                                             | #392  |
| `test/language/expressions/object`                                    | 1     | builtin      | the rest of `Array.prototype` is absent, `toString` among it, so ToPropertyKey of an array literal key reads `Object.prototype.toString` | #390  |
| `test/language/expressions/object`                                    | 1     | builtin      | `new Boolean` has no `[[Construct]]` until the wrapper object exists                                                                     | #501  |
| `test/language/expressions/object/method-definition`                  | 2     | builtin      | `Symbol` is not in the realm                                                                                                             | #392  |
